...
%token LP RP LB RB DOT COMMA COLON MUL DIV PLUS MINUS ID GE GT LE LT EQUAL ASSIGN SYS_CON SYS_FUNCT SYS_PROC SYS_TYPE PROGRAM CONST NAME SEMI INTEGER REAL CHAR STRING TYPE ARRAY RECORD VAR FUNCTION PROCEDURE BEGIN READ IF THEN ELSE REPEAT WHILE FOR TO DOWNTO CASE OF END GOTO NOT AND DO MOD OR UNEQUAL UNTIL
...
factor : NAME  |  NAME  LP  args_list  RP | 
